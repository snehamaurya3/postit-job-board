...
//     applicantId: string,
//   ) {
//     const jobDoc = await this.firebaseService.db
//       .collection('jobs')
//       .doc(jobId)
//       .get();
...
//     const existingApplication = await this.firebaseService.db
...
//   async getJobApplicants(recruiterId: string) {
//     const snapshot = await this.firebaseService.db
//       .collection('applications')
...
//     status: string,
//   ) {
//     const appRef = this.firebaseService.db
//       .collection('applications')
//       .doc(applicationId);
